...
export const manifest = {
  ...
  entries: [
    ...
    {
      "@context": "https://agenticresourcediscovery.org/context/v1",
      identifier: "urn:air:usagemax.com:resource:agent-plugin",
      displayName: "UsageMax Agent Plugin manifest",
      type: "application/json",
      url: `${origin}/plugin.json`,
      trustManifest,
      description: "The canonical UsageMax Agent Plugins manifest for clients that support installable agent integrations.",
      capabilities: ["agent-plugin", "mcp", "cli"],
      representativeQueries: ["Where is the UsageMax agent plugin manifest?", "Which UsageMax agent integration can I install?"],
    },
    {
      "@context": "https://agenticresourcediscovery.org/context/v1",
      identifier: "urn:air:usagemax.com:resource:developer-guide",
      displayName: "UsageMax developer guide",
      type: "text/plain",
      url: `${origin}/developers/llms.txt`,
      trustManifest,
      description: "A concise developer guide covering UsageMax API, MCP, WebMCP, and content-free collector integrations.",
      capabilities: ["developer-documentation", "api-discovery", "integration"],
      representativeQueries: ["How do I integrate with UsageMax?", "Where is the UsageMax developer guide?"],
    },
    {
      "@context": "https://agenticresourcediscovery.org/context/v1",
