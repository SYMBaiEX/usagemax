...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/docs/llms.txt`, lastModified: now, changeFrequency: "weekly", priority: 0.4 },
    { url: `${baseUrl}/developers/llms.txt`, lastModified: now, changeFrequency: "weekly", priority: 0.4 },
    { url: `${baseUrl}/enterprise/llms.txt`, lastModified: now, changeFrequency: "weekly", priority: 0.4 },
    { url: `${baseUrl}/integrations/llms.txt`, lastModified: now, changeFrequency: "weekly", priority: 0.4 },
    ...
    { url: `${baseUrl}/integrations.md`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
