    ...
    <div className={styles.layout}>
      ...
      <section className={styles.access} aria-labelledby="auth-title">
        <div className={styles.form}>
          {signup && <div className={styles.accessLabel}><span className={styles.statusLight} /><span>A fresh perspective</span></div>}
          ...
          {signup && <div className={styles.assurance}><svg width="15" height="17" viewBox="0 0 20 22" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true"><path d="m10 1 8 3v6c0 5-4 9-8 11-4-2-8-6-8-11V4l8-3Z"/><path d="m6 10 3 3 5-6"/></svg><p>Private by default. Publish only when you choose.</p></div>}
