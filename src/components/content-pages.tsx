    ...
    <div className="page-surface content-page docs-page">
      ...
      <div className="shell docs-layout">
        ...
        <article className="docs-article">
          ...
          <section className="docs-section" id="webmcp"><h2>WebMCP</h2><p>When the browser exposes WebMCP, UsageMax registers four bounded read-only tools with <code>document.modelContext.registerTool()</code>. The registration uses an <code>AbortSignal</code> for cleanup and keeps the normal page unchanged when the feature is unavailable.</p><div className="inline-links"><TextLink href="/webmcp">WebMCP guide</TextLink><TextLink href="/webmcp.md">Machine-readable contract</TextLink><TextLink href="https://registry.modelcontextprotocol.io/v0.1/servers/io.github.SYMBaiEX%2Fusagemax/versions/latest">MCP Registry listing</TextLink></div></section>
        </article>
      </div>
    </div>
  );
