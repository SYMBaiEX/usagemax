...
function HomeData() {
  ...
  return <div className="page-surface home-page">
    <section className="home-hero shell"><div className="home-hero-copy"><span className="hero-kicker">The system of record for AI usage</span><h1>AI usage,<br /><em>accounted for.</em></h1><p>One realtime ledger for tokens, spend, models, agents, and outcomes—across every person and machine.</p><div className="home-hero-actions"><Link className="button button-primary" href="/sign-up">Create your account <ArrowUpRight size={16} /></Link><Link className="button button-light" href="/symbaiex">View live profile <ArrowRight size={16} /></Link></div><div className="hero-assurance"><span>GitHub or Google</span><span>Private by default</span><span>No prompts collected</span></div></div><HeroVisual network={network} /></section>
