...
export function agentHomepage() {
  return {
    ...
    developerResources: [
      ...
      { name: "sdk", url: "https://www.npmjs.com/package/usagemax", mediaType: "application/json" },
      { name: "workosWebhook", url: "https://usagemax.com/api/webhooks/workos", mediaType: "application/json" },
