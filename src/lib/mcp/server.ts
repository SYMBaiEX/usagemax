...
export const USAGEMAX_TOOLS = [
  ...
  { name: "leaderboard", title: "Read public leaderboard", description: "Read the public UsageMax leaderboard (maximum 100 rows).", inputSchema: { type: "object", properties: { metric: { type: "string", enum: ["tokens", "spend"], default: "tokens", description: "Rank by aggregate tokens or tracked spend." }, period: { type: "string", enum: ["7d", "30d", "all"], default: "all", description: "Choose the bounded reporting window." } }, additionalProperties: false }, outputSchema: jsonObjectOutput, annotations: readOnlyAnnotations },
